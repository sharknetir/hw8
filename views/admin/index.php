...
<head>
    ...
    <link href="<?= URL.URL_CSS?>/style2.min.css" rel="stylesheet">
</head>
...
<header>
    ...
    <div class="sidebar-fixed position-fixed">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="#" class="list-group-item list-group-item-action waves-effect">
                <i class="fa fa-lock mr-3"></i>Lock</a>

            <a href="#" class="list-group-item list-group-item-action waves-effect">
                <i class="fa fa-users mr-3"></i>Users</a>


            <a href="<?=URL."/hw8/login/logout" ?>" class="list-group-item list-group-item-action waves-effect">
                <i class="fa fa-sign-out mr-3"></i>Exit</a>
        </div>
                                ...
                                foreach ($params as $item=>$value){
                                    ...
                                    $test=[];
                                        foreach ($value as $key=>$val) {
                                            ...
                                            echo "<td class=\"pt-3-half\" contenteditable=\"true\"id='$key/$item' >" . $val . "</td>";
                                            array_push($test,$val);
                                                }
                                                echo "<td><span class=\"table-remove\"><button type=\"button\" class=\"btn btn-danger btn-rounded btn-sm my-0\">Remove</button></span></td>";
                                                echo "<td><span class=\"table-update\" id=\"update$item\"><button type=\"button\" class=\"btn btn-info btn-rounded btn-sm my-0\"><a href='../admin/update/$test[2]*$item'>Enable</a></button></span></td>";
...
<script>
    ...
    //     });
        ...
        // Save data
        // $(".table-update").focusout(function(){
